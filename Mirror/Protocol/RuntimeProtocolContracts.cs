...
namespace DingoGameObjectsCMS.Mirror.Protocol
{
    ...
    public static class RuntimeSessionDescriptorValidator
    {
        public static RuntimeProtocolRejectCode Validate(in RuntimeSessionDescriptor expected, in RuntimeSessionDescriptor actual)
        {
            if (actual.ProtocolVersion != RuntimeProtocol.VERSION || actual.ProtocolVersion != expected.ProtocolVersion)
