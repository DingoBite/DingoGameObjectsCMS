...
namespace DingoGameObjectsCMS.Mirror.Protocol
{
    ...
    public class RuntimeClientLogicalEnvelopeReceiver
    {
        ...
        public RuntimeClientLogicalEnvelopeReceiver(
            ...
            int maxPendingEnvelopeCount = RuntimeProtocol.MAX_PENDING_ENVELOPES,
            int maxPendingBytes = RuntimeProtocol.MAX_PENDING_ENVELOPE_BYTES,
        ...
        public RuntimeClientReceiveResult Tick(double nowSeconds)
        {
            ...
            if (_baselineAssembler.IsActive
                && nowSeconds - _baselineStartedAt > RuntimeProtocol.BASELINE_TIMEOUT_SECONDS)
            {
